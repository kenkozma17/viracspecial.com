                ...
                <div class="locations-list">
                    <div class="card mb-3" v-for="(location, index) in locations">
                        <div class="row no-gutters">
                            <div class="col-md-4">
                                <div class="image" :style="{ 'background-image': 'url(' + location.image + ')' }"></div>
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
...
<script>
    ...
    module.exports = {
        ...
        mounted() {
            ...
            const buildingBtn = document.querySelectorAll('.card-title');
            if(buildingBtn) {
                buildingBtn.forEach(function(el) {
